        ...
        <header className="header px-10 py-7 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-4 mb-2">
              <h2 className="text-3xl font-black text-white">Stock Items</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <span className="text-2xl">+</span> Add Stock Item
            </button>
            <button
        ...
        <div className="flex-1 overflow-auto p-10">
          {loading ? (
            <div className="flex flex-col items-center justify-center h-full text-slate-400">
              ...
              <p className="text-xl font-semibold">Loading stock items...</p>
            </div>
          ) : (
            <div className="glass-card table-glass rounded-3xl border border-white/10 overflow-hidden fade-in">
              {items.length === 0 ? (
                <div className="p-24 text-center">
                  ...
                  <p className="text-slate-400 text-lg mb-6">Create your first stock item to get started</p>
                  <button
                    onClick={() => {
                      setEditingItem(null);
                      resetForm();
