        ...
        <header className="header px-10 py-7 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-4 mb-2">
              <h2 className="text-3xl font-black text-white">Audit Logs</h2>
            ...
            <div className="glass-card table-glass rounded-3xl border border-white/10 overflow-hidden fade-in">
              {logs.length === 0 ? (
                <div className="p-24 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-slate-200 mb-3">No Audit Logs Yet</h3>
                  <p className="text-slate-400 text-lg">Activity logs will appear here as you use the system.</p>
                </div>
              ) : (
                <table className="min-w-full divide-y divide-white/10">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {logs.map((log) => (
                      <tr key={log.id} className="table-row hover:bg-purple-500/10 transition-all">
                        <td className="px-8 py-6 whitespace-nowrap">
                          <div className="text-lg font-semibold text-white">{log.user_name || 'System'}</div>
                        </td>
                        <td className="px-8 py-6 whitespace-nowrap">
